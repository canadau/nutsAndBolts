...
public class Cart implements Serializable {
	...
	public void addToCart2(Products pro) {
		...
		if (isExist) {
			...
			products2 = new Products(pro.getSku(), pro.getName(), pro.getDescription(), pro.getPrice(), pro.getQty(),
					1);
	...
	public void reduceInventory(List<Products> list) {
		...
		try {
			...
			// catch statement to catch any error while connecting to our database. This saves the app from crash in an error occurs
	...
	public String viewReceipt() {
		reduceInventory(productsListNoDub);
		orderNumber();
